...
public class Formula implements Comparable<Formula> {
    ...
    private BitSet rightOfWhichUntils; // for bug fix - formula can be right of
                                       // >1 untils
    ...
    public static boolean is_reserved_char(char ch) {
        ...
        case '-':
            ...
            // ! not allowed by Java identifiers anyway - maybe some above
            // neither?
            return true;
    ...
    public Formula getNext() {
        ...
        default:
            ...
            // " Switch did not find a relevant case...");
            return null;
        }
    }
    ...
    public boolean is_synt_implied(TreeSet<Formula> old, TreeSet<Formula> next) {
        ...
        if (!is_literal()) // non-elementary formula
        {
            ...
            default:
                System.out
                        .println("Default case of switch at Form.synt_implied");
    ...
    public String toString(boolean exprId) {
        ...
        case 'W':
            ...
            // case 'M': return "( " + left.toString(true) + " M " +
            // right.toString(true) + " )[" + id + "]";
        case 'X':
    ...
    private Formula getMatch(String strName) {
        return matches.get(strName);
    }

    private void addMatch(String strName, Formula expr) {
        matches.put(strName, expr);
    }
    ...
    private boolean match(Formula rule) {
        ...
        Hashtable<String, Formula> saved = (Hashtable<String, Formula>) matches
                .clone();
