...
public class Node {
    ...
    public Node(Node n) {
        ...
        for (Iterator<Edge> i = n.outgoingEdges.iterator(); i.hasNext();) {
            ...
            Edge e = new Edge(this, i.next());
        }

        for (Iterator<Edge> i = n.incomingEdges.iterator(); i.hasNext();) {
            @SuppressWarnings("unused")
            Edge e = new Edge(i.next(), this);
        }
    }
    ...
    public synchronized void forAllEdges(IVisitor v) {
        for (Iterator<Edge> i = new LinkedList<Edge>(outgoingEdges).iterator(); i
                .hasNext();) {
            v.visitEdge(i.next());
        }
    }
    ...
    public synchronized void remove() {
        ...
        for (Iterator<Edge> i = new LinkedList<Edge>(incomingEdges).iterator(); i
                .hasNext();) {
            (i.next()).remove();
        }
